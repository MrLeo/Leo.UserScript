...
$(function(){
    ...
    //设置样式
    var styles = '';
    styles += '.copy{float: left; line-height:35px; display: block; text-align: center; width: 100%; margin: 10px 0; box-sizing: border-box; background-color: #3476DA; font-size: larger; font-weight: bolder; color: #fff !important; border-radius: 10px; }';
